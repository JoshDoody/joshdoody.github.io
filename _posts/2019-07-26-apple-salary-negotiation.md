---
layout: post
title: Apple salary negotiation - How to negotiate a Apple job offer
...
---
The key question to ask about a Apple job offer is "How much flexibility do they have to negotiate my specific offer?" In my experience [coaching software developers](/coach/) through Apple salary negotiations, the answer varies from "not much" to "a whole lot".
...
For example, Apple needs lots engineers with experience in embedded systems, machine learning, an AI, and the supply of experienced engineers in those areas of expertise is relatively tight among the big tech companies. So Apple will offer competitive salaries with some room to negotiate to get quality software engineers with that expertise to join their team.

By contrast, many junior generalist software engineers are eager to join Apple and there is an increasigly large supply as more and more people shift into software. So Apple's offers for more junior engineers are often pretty close to their best offer right out of the gate. That doesn't mean there's *no* room to negotiate, but their offers are tuned to a competitive baseline, so smaller improvements are more common than larger ones.
...
Once you actually get through the Apple interview process, you may receive a job offer. Let's look at an example to see what you can expect.
...
Here's an example taken from a modified version of a real Apple job offer from one of my clients (all numbers are $1,000s). This client was a very experienced software developer with substantial experience in embedded systems. This offer is for $210,000 base salary, $400,000 total equity (vesting over four years), and a $100,000 sign-on bonus:
...
Let's look a little closer at the main components of a Apple job offer.
...
The equity component of a Apple job offer can range from "not very much" to "Whoa, I had no idea that was possible!" depending on the role and the candidate.
...
Although Apple is typically only moderately flexible on base salary, I prefer to begin by negotiating base salary to see how flexible they are in the other components. By pushing on base salary—even knowing they aren't very flexible—we give them an opportunity to show where they *are* the most flexible.
...
## What to look out for when negotiating a Apple job offer package
